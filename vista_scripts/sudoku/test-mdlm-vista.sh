#!/bin/bash
# SLURM job script for testing MDLM on Sudoku dataset on Vista supercomputer

#SBATCH -J mdlm-test                 # Job name
...
CHECKPOINT_DIR="output/sudoku/mdlm-alpha0.25-gamma1-bs1024-lr1e-3-ep300-T20-vista-YYYYMMDD-HHMMSS"
